...
deploy: package
	...
	curl -T *.deb -ualdrinleal:$(BINTRAY_APIKEY) 'https://api.bintray.com/content/ingenieux/lfs-deb/$(NAME)/$(VERSION)/$(shell basename *.deb);deb_component=main;deb_architecture=amd64;publish=1'
